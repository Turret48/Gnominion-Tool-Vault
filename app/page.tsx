                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-wrap sm:flex-nowrap items-baseline gap-2">
                    {headerEditing ? (
                      ...
                      <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight leading-none">{editedTool.name}</h1>
                    )}
                    {headerEditing ? (
                      <input
                    ...
                    <button
                      ...
                      className="h-8 w-8 flex items-center justify-center rounded-full bg-black border border-border text-secondary hover:text-white hover:border-gray-500 transition-all shrink-0 self-end"
